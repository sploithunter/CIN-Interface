...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function og(i,t,e){const n=new Float32Array(ai),s=new R(0,1,0);return new En({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Br(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function rc(){return new En({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Br(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function oc(){return new En({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Br(),fragmentShader:`
	...
	`}function ag(i){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Go||l===Vo,h=l===ui||l===ki;if(c||h){let u=t.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return e===null&&(e=new ic(i)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return c&&p&&p.height>0||h&&p&&s(p)?(e===null&&(e=new ic(i)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function s(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function lg(i){const t={};function e(n){if(t[n]!==void 0)return t[n];const s=i.getExtension(n);return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&gs("WebGLRenderer: "+n+" extension not supported."),s}}}function cg(i,t,e,n){const s={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete s[d.id];const p=r.get(d);p&&(t.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const p in d)t.update(d[p],i.ARRAY_BUFFER)}function c(u){const d=[],p=u.index,g=u.attributes.position;let x=0;if(p!==null){const T=p.array;x=p.version;for(let E=0,M=T.length;E<M;E+=3){const A=T[E+0],C=T[E+1],P=T[E+2];d.push(A,C,C,P,P,A)}}else if(g!==void 0){const T=g.array;x=g.version;for(let E=0,M=T.length/3-1;E<M;E+=3){const A=E+0,C=E+1,P=E+2;d.push(A,C,C,P,P,A)}}else return;const m=new(nh(d)?ah:oh)(d,1);m.version=x;const f=r.get(u);f&&t.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function hg(i,t,e){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,p){i.drawElements(n,p,r,d*o),e.update(p,n,1)}function c(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*o,g),e.update(p,n,g))}function h(d,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];e.update(m,n,1)}function u(d,p,g,x){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/o,p[f],x[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,x,0,g);let f=0;for(let T=0;T<g;T++)f+=p[T]*x[T];e.update(f,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function ug(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(e.calls++,o){case i.TRIANGLES:e.triangles+=a*(r/3);break;case i.LINES:e.lines+=a*(r/2);break;case i.LINE_STRIP:e.lines+=a*(r-1);break;case i.LINE_LOOP:e.lines+=a*r;break;case i.POINTS:e.points+=a*r;break;default:Zt("WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function dg(i,t,e){const n=new WeakMap,s=new ge;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let y=function(){N.dispose(),n.delete(a),a.removeEventListener("dispose",y)};var p=y;d!==void 0&&d.texture.dispose();const g=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],T=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let M=0;g===!0&&(M=1),x===!0&&(M=2),m===!0&&(M=3);let A=a.attributes.position.count*M,C=1;A>t.maxTextureSize&&(C=Math.ceil(A/t.maxTextureSize),A=t.maxTextureSize);const P=new Float32Array(A*C*4*u),N=new sh(P,A,C,u);N.type=mn,N.needsUpdate=!0;const v=M*4;for(let L=0;L<u;L++){const z=f[L],O=T[L],q=E[L],G=A*C*4*L;for(let V=0;V<z.count;V++){const B=V*v;g===!0&&(s.fromBufferAttribute(z,V),P[G+B+0]=s.x,P[G+B+1]=s.y,P[G+B+2]=s.z,P[G+B+3]=0),x===!0&&(s.fromBufferAttribute(O,V),P[G+B+4]=s.x,P[G+B+5]=s.y,P[G+B+6]=s.z,P[G+B+7]=0),m===!0&&(s.fromBufferAttribute(q,V),P[G+B+8]=s.x,P[G+B+9]=s.y,P[G+B+10]=s.z,P[G+B+11]=q.itemSize===4?s.w:1)}}d={count:u,texture:N,size:new tt(A,C)},n.set(a,d),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function fg(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(s.get(u)!==c&&(t.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:o}}const pg={[Hc]:"LINEAR_TONE_MAPPING",[kc]:"REINHARD_TONE_MAPPING",[Gc]:"CINEON_TONE_MAPPING",[Vc]:"ACES_FILMIC_TONE_MAPPING",[Xc]:"AGX_TONE_MAPPING",[qc]:"NEUTRAL_TONE_MAPPING",[Wc]:"CUSTOM_TONE_MAPPING"};function mg(i,t,e,n,s){const r=new vn(t,e,{type:i,depthBuffer:n,stencilBuffer:s}),o=new vn(t,e,{type:Fn,depthBuffer:!1,stencilBuffer:!1}),a=new xe;a.setAttribute("position",new Jt([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Jt([0,2,0,0,2,0],2));const l=new sf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Nt(a,l),h=new nl(-1,1,1,-1,0,1);let u=null,d=null,p=!1,g,x=null,m=[],f=!1;this.setSize=function(T,E){r.setSize(T,E),o.setSize(T,E);for(let M=0;M<m.length;M++){const A=m[M];A.setSize&&A.setSize(T,E)}},this.setEffects=function(T){m=T,f=m.length>0&&m[0].isRenderPass===!0;const E=r.width,M=r.height;for(let A=0;A<m.length;A++){const C=m[A];C.setSize&&C.setSize(E,M)}},this.begin=function(T,E){if(p||T.toneMapping===_n&&m.length===0)return!1;if(x=E,E!==null){const M=E.width,A=E.height;(r.width!==M||r.height!==A)&&this.setSize(M,A)}return f===!1&&T.setRenderTarget(r),g=T.toneMapping,T.toneMapping=_n,!0},this.hasRenderPass=function(){return f},this.end=function(T,E){T.toneMapping=g,p=!0;let M=r,A=o;for(let C=0;C<m.length;C++){const P=m[C];if(P.enabled!==!1&&(P.render(T,A,M,E),P.needsSwap!==!1)){const N=M;M=A,A=N}}if(u!==T.outputColorSpace||d!==T.toneMapping){u=T.outputColorSpace,d=T.toneMapping,l.defines={},jt.getTransfer(u)===ee&&(l.defines.SRGB_TRANSFER="");const C=pg[d];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=M.texture,T.setRenderTarget(x),T.render(c,h),x=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),l.dispose()}}const Ah=new De,Pa=new xs(1,1),Ch=new sh,Rh=new Ku,Ph=new hh,ac=[],lc=[],cc=new Float32Array(16),hc=new Float32Array(9),uc=new Float32Array(4);function qi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=ac[s];if(r===void 0&&(r=new Float32Array(s),ac[s]=r),t!==0){n.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,i[o].toArray(r,a)}return r}function be(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function Te(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function zr(i,t){let e=lc[t];e===void 0&&(e=new Int32Array(t),lc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function gg(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function _g(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;i.uniform2fv(this.addr,t),Te(e,t)}}function xg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(be(e,t))return;i.uniform3fv(this.addr,t),Te(e,t)}}function vg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;i.uniform4fv(this.addr,t),Te(e,t)}}function Sg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(be(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),Te(e,t)}else{if(be(e,n))return;uc.set(n),i.uniformMatrix2fv(this.addr,!1,uc),Te(e,n)}}function Mg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(be(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),Te(e,t)}else{if(be(e,n))return;hc.set(n),i.uniformMatrix3fv(this.addr,!1,hc),Te(e,n)}}function yg(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(be(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),Te(e,t)}else{if(be(e,n))return;cc.set(n),i.uniformMatrix4fv(this.addr,!1,cc),Te(e,n)}}function Eg(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function bg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;i.uniform2iv(this.addr,t),Te(e,t)}}function Tg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;i.uniform3iv(this.addr,t),Te(e,t)}}function wg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;i.uniform4iv(this.addr,t),Te(e,t)}}function Ag(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Cg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;i.uniform2uiv(this.addr,t),Te(e,t)}}function Rg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;i.uniform3uiv(this.addr,t),Te(e,t)}}function Pg(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;i.uniform4uiv(this.addr,t),Te(e,t)}}function Lg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Pa.compareFunction=e.isReversedDepthBuffer()?Wa:Va,r=Pa):r=Ah,e.setTexture2D(t||r,s)}function Dg(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Rh,s)}function Ig(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Ph,s)}function Ug(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Ch,s)}function Ng(i){switch(i){case 5126:return gg;case 35664:return _g;case 35665:return xg;case 35666:return vg;case 35674:return Sg;case 35675:return Mg;case 35676:return yg;case 5124:case 35670:return Eg;case 35667:case 35671:return bg;case 35668:case 35672:return Tg;case 35669:case 35673:return wg;case 5125:return Ag;case 36294:return Cg;case 36295:return Rg;case 36296:return Pg;case 35678:case 36198:case 36298:case 36306:case 35682:return Lg;case 35679:case 36299:case 36307:return Dg;case 35680:case 36300:case 36308:case 36293:return Ig;case 36289:case 36303:case 36311:case 36292:return Ug}}function Fg(i,t){i.uniform1fv(this.addr,t)}function Og(i,t){const e=qi(t,this.size,2);i.uniform2fv(this.addr,e)}function Bg(i,t){const e=qi(t,this.size,3);i.uniform3fv(this.addr,e)}function zg(i,t){const e=qi(t,this.size,4);i.uniform4fv(this.addr,e)}function Hg(i,t){const e=qi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function kg(i,t){const e=qi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Gg(i,t){const e=qi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Vg(i,t){i.uniform1iv(this.addr,t)}function Wg(i,t){i.uniform2iv(this.addr,t)}function Xg(i,t){i.uniform3iv(this.addr,t)}function qg(i,t){i.uniform4iv(this.addr,t)}function Yg(i,t){i.uniform1uiv(this.addr,t)}function Zg(i,t){i.uniform2uiv(this.addr,t)}function $g(i,t){i.uniform3uiv(this.addr,t)}function jg(i,t){i.uniform4uiv(this.addr,t)}function Kg(i,t,e){const n=this.cache,s=t.length,r=zr(e,s);be(n,r)||(i.uniform1iv(this.addr,r),Te(n,r));let o;this.type===i.SAMPLER_2D_SHADOW?o=Pa:o=Ah;for(let a=0;a!==s;++a)e.setTexture2D(t[a]||o,r[a])}function Jg(i,t,e){const n=this.cache,s=t.length,r=zr(e,s);be(n,r)||(i.uniform1iv(this.addr,r),Te(n,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Rh,r[o])}function Qg(i,t,e){const n=this.cache,s=t.length,r=zr(e,s);be(n,r)||(i.uniform1iv(this.addr,r),Te(n,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Ph,r[o])}function t0(i,t,e){const n=this.cache,s=t.length,r=zr(e,s);be(n,r)||(i.uniform1iv(this.addr,r),Te(n,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Ch,r[o])}function e0(i){switch(i){case 5126:return Fg;case 35664:return Og;case 35665:return Bg;case 35666:return zg;case 35674:return Hg;case 35675:return kg;case 35676:return Gg;case 5124:case 35670:return Vg;case 35667:case 35671:return Wg;case 35668:case 35672:return Xg;case 35669:case 35673:return qg;case 5125:return Yg;case 36294:return Zg;case 36295:return $g;case 36296:return jg;case 35678:case 36198:case 36298:case 36306:case 35682:return Kg;case 35679:case 36299:case 36307:return Jg;case 35680:case 36300:case 36308:case 36293:return Qg;case 36289:case 36303:case 36311:case 36292:return t0}}class n0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Ng(e.type)}}class i0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=e0(e.type)}}class s0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(t,e[a.id],n)}}}const Eo=/(\w+)(\])?(\[|\.)?/g;function dc(i,t){i.seq.push(t),i.map[t.id]=t}function r0(i,t,e){const n=i.name,s=n.length;for(Eo.lastIndex=0;;){const r=Eo.exec(n),o=Eo.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){dc(e,c===void 0?new n0(a,i,t):new i0(a,i,t));break}else{let u=e.map[a];u===void 0&&(u=new s0(a),dc(e,u)),e=u}}}class xr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=t.getActiveUniform(e,o),l=t.getUniformLocation(e,a.name);r0(a,l,this)}const s=[],r=[];for(const o of this.seq)o.type===t.SAMPLER_2D_SHADOW||o.type===t.SAMPLER_CUBE_SHADOW||o.type===t.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,o=e.length;r!==o;++r){const a=e[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const o=t[s];o.id in e&&n.push(o)}return n}}function fc(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const o0=37297;let a0=0;function l0(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}const pc=new Gt;function c0(i){jt._getMatrix(pc,jt.workingColorSpace,i);const t=`mat3( ${pc.elements.map(e=>e.toFixed(4))} )`;switch(jt.getTransfer(i)){case Sr:return[t,"LinearTransferOETF"];case ee:return[t,"sRGBTransferOETF"];default:return Ot("WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function mc(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=(i.getShaderInfoLog(t)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return e.toUpperCase()+`
...
`)}const u0={[Hc]:"Linear",[kc]:"Reinhard",[Gc]:"Cineon",[Vc]:"ACESFilmic",[Xc]:"AgX",[qc]:"Neutral",[Wc]:"Custom"};function d0(i,t){const e=u0[t];return e===void 0?(Ot("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const or=new R;function f0(){jt.getLuminanceCoefficients(or);const i=or.x.toFixed(4),t=or.y.toFixed(4),e=or.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function g0(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function as(i){return i!==""}function gc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function _c(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const _0=/^[ \t]*#include +<([\w\d./]+)>/gm;function La(i){return i.replace(_0,v0)}const x0=new Map;function v0(i,t){let e=Vt[t];if(e===void 0){const n=x0.get(t);if(n!==void 0)e=Vt[n],Ot('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return La(e)}const S0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xc(i){return i.replace(S0,M0)}function M0(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function vc(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}const y0={[fr]:"SHADOWMAP_TYPE_PCF",[ss]:"SHADOWMAP_TYPE_VSM"};function E0(i){return y0[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const b0={[ui]:"ENVMAP_TYPE_CUBE",[ki]:"ENVMAP_TYPE_CUBE",[Fr]:"ENVMAP_TYPE_CUBE_UV"};function T0(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":b0[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const w0={[ki]:"ENVMAP_MODE_REFRACTION"};function A0(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":w0[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const C0={[zc]:"ENVMAP_BLENDING_MULTIPLY",[_u]:"ENVMAP_BLENDING_MIX",[xu]:"ENVMAP_BLENDING_ADD"};function R0(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":C0[i.combine]||"ENVMAP_BLENDING_NONE"}function P0(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function L0(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=E0(e),c=T0(e),h=A0(e),u=R0(e),d=P0(e),p=p0(e),g=m0(r),x=s.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
  ...
  `}).join(""),Ro.querySelectorAll(".session-card").forEach(r=>{r.addEventListener("click",o=>{o.target.classList.contains("session-action-btn")||zi(r.getAttribute("data-session"))})}),Ro.querySelectorAll(".session-action-btn").forEach(r=>{r.addEventListener("click",async o=>{o.stopPropagation();const l=r.closest(".session-card")?.getAttribute("data-session"),c=r.dataset.action;if(l){if(c==="delete"){const h=ye.find(u=>u.id===l);if(confirm(`Delete session "${h?.name}"?`)){const u=await Sn.deleteSession(l);u.ok?Ge(`Deleted ${h?.name}`,"success"):Ge(u.error||"Failed to delete session","error")}}else if(c==="restart"){const h=ye.find(d=>d.id===l),u=await Sn.restartSession(l);u.ok?Ge(`Restarted ${h?.name}`,"success"):Ge(u.error||"Failed to restart session","error")}}})}),Ih()}function $_(i,t=!1,e=!1){const n=t?'<span class="session-type-tag">ext</span> ':"",s=e?' <span class="session-unplaced-tag">⊕</span>':"";if(i.status==="waiting")return`${n}<span class="needs-attention">⚡ Needs attention</span>${s}`;if(i.currentTool)return`${n}<span class="session-tool">${Le(i.currentTool)}</span>${s}`;if(i.status==="working")return`${n}Working...${s}`;if(i.status==="offline")return`${n}Offline${s}`;const r=i.cwd?.split("/").pop()||"Idle";return`${n}${r}${s}`}function zi(i){Se=i,document.querySelectorAll(".session-card").forEach(t=>{t.classList.toggle("selected",t.getAttribute("data-session")===i)}),hi?.selectZone(i==="all"?null:i),Ih(),Uh()}function Ih(){if(Se==="all"||!Se)Dc.textContent="Select a session to send",Ir.disabled=!0,Yn.placeholder="Send a prompt to the selected session...";else{const i=ye.find(t=>t.id===Se);Dc.textContent=i?`Sending to: ${i.name}`:"Select a session to send",Ir.disabled=!i||i.status==="offline",i?.suggestion?Yn.placeholder=i.suggestion:Yn.placeholder="Send a prompt to the selected session..."}}function Uh(){const i=j_();i.length===0?(Da.classList.remove("hidden"),Es.querySelectorAll(".feed-item").forEach(t=>t.remove())):(Da.classList.add("hidden"),Es.innerHTML="",i.forEach(t=>Fh(t,!1)),Oh())}function j_(){if(Se==="all")return Lr;const i=ye.find(t=>t.id===Se);return i?Lr.filter(t=>Nh(t,i)):[]}function Nh(i,t){return t.claudeSessionId?i.sessionId===t.claudeSessionId:i.cwd!==t.cwd?!1:!new Set(ye.filter(n=>n.id!==t.id&&n.claudeSessionId).map(n=>n.claudeSessionId)).has(i.sessionId)}function Fh(i,t=!0){if(Se!=="all"){const h=ye.find(u=>u.id===Se);if(!h||!Nh(i,h))return}Da.classList.add("hidden");const e=document.createElement("div");e.className=`feed-item ${K_(i)}`;const n=i.tool||i.type,s=J_(i.tool),r=i.duration?`<span class="feed-item-duration">${i.duration}ms</span>`:"",o=Q_(i),a=o?`<div class="feed-item-file">${Le(o)}</div>`:"",l=i.tool&&["Edit","Write","Read"].includes(i.tool)&&i.toolInput,c=ex(i);if(l){const h=ur(i);e.innerHTML=`
      <div class="feed-item-header">
        <span class="feed-item-tool">${s}${Le(n)}</span>
        <span class="feed-item-time">${Po(i.timestamp)}${r}</span>
      </div>
      ${a}
      <div class="feed-item-toggle">Show content</div>
      <div class="feed-item-expandable">
        <div class="feed-item-content">${h}</div>
      </div>
    `;const u=e.querySelector(".feed-item-toggle");u?.addEventListener("click",()=>{u.classList.toggle("expanded")})}else if(c){const h=ur(i,!1),u=ur(i,!0);e.innerHTML=`
      <div class="feed-item-header">
        <span class="feed-item-tool">${s}${Le(n)}</span>
        <span class="feed-item-time">${Po(i.timestamp)}${r}</span>
      </div>
      ${a}
      <div class="feed-item-content feed-item-preview">${h}</div>
    ...
    `;const d=e.querySelector(".feed-item-toggle");d?.addEventListener("click",()=>{d.classList.toggle("expanded");const p=e.querySelector(".feed-item-preview");d.classList.contains("expanded")?(d.textContent="Show less",p?.classList.add("hidden")):(d.textContent="Show full response",p?.classList.remove("hidden"))})}else e.innerHTML=`
      <div class="feed-item-header">
        <span class="feed-item-tool">${s}${Le(n)}</span>
        <span class="feed-item-time">${Po(i.timestamp)}${r}</span>
      </div>
  ...
  `;e.length>0&&(n+='<div class="hex-menu-divider"></div>',e.forEach((a,l)=>{const c=a.type==="external"?' <span class="hex-menu-badge">ext</span>':"";n+=`
        <div class="hex-menu-option" data-action="place-session" data-session-id="${a.id}">
          ...
          <span class="hex-menu-label">Place: ${Le(a.name)}${c}</span>
        </div>
      `})),n+='<div class="hex-menu-hint">Click elsewhere to dismiss</div>',ke.innerHTML=n,ke.querySelectorAll(".hex-menu-option").forEach(a=>{a.addEventListener("click",l=>{l.stopPropagation();const c=a.dataset.action,h=bs;if(c==="create-zone"&&h)Ln(),vr(h);else if(c==="place-session"){const u=a.dataset.sessionId;u&&h&&sx(u,h),Ln()}})}),ke.style.left=`${t.x}px`,ke.style.top=`${t.y}px`,ke.classList.remove("hidden");const s=ke.getBoundingClientRect(),r=window.innerWidth,o=window.innerHeight;s.right>r&&(ke.style.left=`${t.x-s.width}px`),s.bottom>o&&(ke.style.top=`${t.y-s.height}px`)}function Ln(){ke.classList.add("hidden"),bs=null}async function sx(i,t){try{const e=await Sn.updateSession(i,{zonePosition:t});if(e.ok){const n=ye.find(s=>s.id===i);Ge(`Placed ${n?.name||"session"} on grid`,"success")}else Ge(e.error||"Failed to place session","error")}catch{Ge("Failed to place session","error")}}async function vr(i){Dr=i||null,Ur.classList.remove("hidden");try{const t=await Sn.getDefaultPath();Nc.textContent=t.path,cn.value||(cn.value=t.path,Na())}catch{Nc.textContent="~/Documents"}try{const t=await Sn.getProjects();Uc.innerHTML=t.projects.slice(0,6).map(e=>`<div class="recent-project" data-path="${Le(e.path)}">${Le(e.name)}</div>`).join(""),Uc.querySelectorAll(".recent-project").forEach(e=>{e.addEventListener("click",()=>{cn.value=e.getAttribute("data-path")||"",Na()})})}catch(t){console.error("[CIN] Failed to load projects:",t)}cn.focus()}function Bh(){Ur.classList.add("hidden"),cn.value="",Nr.value="",Dr=null}function Na(){const i=cn.value;if(i&&!Nr.value){const t=i.split("/").filter(Boolean);Nr.placeholder=t[t.length-1]||"Auto-filled from directory..."}}async function rx(){const i=cn.value||void 0,e={name:Nr.value||void 0,cwd:i,flags:{continue:z_.checked,skipPermissions:H_.checked,chrome:k_.checked}};Dr&&(e.zonePosition=Dr);try{ls.textContent="Creating...",ls.setAttribute("disabled","true");const n=await Sn.createSession(e);n.ok&&n.session?(Bh(),zi(n.session.id),Ge(`Created zone: ${n.session.name}`,"success")):Ge(n.error||"Failed to create session","error")}catch(n){console.error("[CIN] Failed to create session:",n),Ge("Failed to create session","error")}finally{ls.textContent="Create",ls.removeAttribute("disabled")}}async function Oc(){let i=Yn.value.trim();if(!i&&Se&&Se!=="all"){const t=ye.find(e=>e.id===Se);t?.suggestion&&(i=t.suggestion)}if(!(!i||!Se||Se==="all"))try{Ir.disabled=!0;const t=await Sn.sendPrompt(Se,i);t.ok?(Yn.value="",sl.classList.remove("hidden")):Ge(t.error||"Failed to send prompt","error")}catch(t){console.error("[CIN] Failed to send prompt:",t),Ge("Failed to send prompt","error")}finally{Ir.disabled=!1}}function Ge(i,t="success"){const e=document.getElementById("toast-container"),n=document.createElement("div");n.className=`toast ${t}`,n.textContent=i,e.appendChild(n),setTimeout(()=>n.remove(),3e3)}W_();
